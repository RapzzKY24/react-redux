...
export default function ProductCard({
  ...
  return (
    <div className="w-full bg-white/50 rounded-xl border shadow p-4 relative">
      ...
      <button
        onClick={() => onWhislist(item.id)}
        className="absolute top-2 left-2 p-2 bg-gray-200 rounded-full hover:bg-gray-300 transition-colors duration-200 z-10"
      ...
      >
        {isWhislisted ? (
          ...
          <Heart className="text-gray-700 text-lg" />
        )}
      </button>
